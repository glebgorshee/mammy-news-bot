...
SOURCES = {
    ...
    "msk_events": {
        ...
        "interests": (
            ...
            "ОБЯЗАТЕЛЬНОЕ ТРЕБОВАНИЕ: событие должно быть В БУДУЩЕМ или СЕГОДНЯ "
            "(а не отчёт о прошедшем). Если новость = пост-репортаж 'как прошло' — ОТКЛОНЯЙ. "
            "Если упоминается дата — она должна быть в будущем.\n\n"
            "НЕ ПОДХОДИТ:\n"
